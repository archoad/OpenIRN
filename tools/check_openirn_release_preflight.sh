...
require_grep '--inputDirectory' .github/workflows/release.yml 'répertoire du MSIX Store transmis explicitement au CLI'
forbidden_grep '--inputFile' .github/workflows/release.yml 'option MSStore CLI incompatible --inputFile'
